...
export default function Wizard(props) {
    const { nodes, materials } = useGLTF('/models/wizard-transformed.glb') // Load the model
    const modelRef = useRef() // Create a reference to the model

    // Make the wizard move up and down
    useFrame((state, delta, xrFrame) => {
        modelRef.current.position.y = Math.sin(state.clock.getElapsedTime()) * 0.15 - 1.5;
    })

    return (
        // Render the model with the given props
